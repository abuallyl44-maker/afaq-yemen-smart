/**
 * ملف ربط النماذج (Models Index) - نسخة Vercel
...
WhatsAppSession.belongsTo(WhatsAppBot, { foreignKey: 'bot_id', as: 'whatsapp_bot' });
...
DeleteEditTrackingSetting.belongsTo(WhatsAppBot, { foreignKey: 'bot_id', as: 'tracking_whatsapp_bot' });

// ==================== TelegramBot ====================
// بوت تيليجرام -> المشتركين
TelegramBot.hasMany(TelegramSubscriber, { foreignKey: 'bot_id', as: 'subscribers' });
TelegramSubscriber.belongsTo(TelegramBot, { foreignKey: 'bot_id', as: 'telegram_bot' });
